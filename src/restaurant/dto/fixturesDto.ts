...
export const jackRabbitSlims: RestaurantDto = {
...
export const gusteaus: RestaurantDto = {
...
export const leakyCauldron: RestaurantDto = {
...
export const pizzaPlanet: RestaurantDto = {
...
export const threeBroomsticks: RestaurantDto = {
...
export const kelpShake: RestaurantDto = {
...
export const moesTavern: RestaurantDto = {
